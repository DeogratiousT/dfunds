<button class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-bs-toggle="modal" data-bs-target="#edit-county-{{ $county->id }}-modal">
...
<button class="btn btn-icon btn-bg-light btn-active-color-danger btn-sm me-1" data-bs-toggle="modal" data-bs-target="#delete-county-{{ $county->id }}-modal">
...
<div class="modal fade" tabindex="-1" id="delete-county-{{ $county->id }}-modal" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Delete {{ $county->name }}</h4>
            ...
            <div class="modal-body row">
                <form action="{{ route('counties.destroy', $county) }}" method="POST" id="delete-county-{{ $county->id }}-form">
                    @csrf
                    @method('DELETE')

                    <p>Deleting this county deletes all is related Counties and Payams</p>
...
<script>
    ...
    function editCounty(obj, county){
        event.preventDefault();
