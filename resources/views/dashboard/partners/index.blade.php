...
@section('page-right')
    <button  class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#create-partner-modal">
...
@section('content')
    <div class="card">
        <div class="card-body">
            <table id="partners-laratable" class="table table-striped table-row-bordered gy-5 gs-7 border rounded">
                <thead>
    ...
    <!--start:: Create Modal -->
    <div class="modal fade" tabindex="-1" id="create-partner-modal" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                ...
                <div class="modal-body row">
                    <form action="{{ route('partners.store') }}" method="post">
                        ...
                        <div class="col-12">
                            ...
                            <button type="submit" id="kt_partners_submit" class="btn btn-primary">
...
@push('scripts')
    ...
    <script>
        let subButton = document.getElementById('kt_partners_submit');
        ...
        (event) => {
            ...
            axios.post("{{ route('partners.store') }}", requestBody)
            .then((response) => {
                if (response.data.success) {
                    ...
                    let createPartnerModal = document.getElementById('create-partner-modal');
                    let modal = bootstrap.Modal.getInstance(createPartnerModal);
                    modal.show();
                }
            })
            .catch((error) => {
